...
public final class PptSlice2 extends PptSlice {
  ...
  public void merge_invariants() {
    ...
    for (PptRelation rel : parent.children) {
      ...
      // Child variable info
      /*NNC:@LazyNonNull*/ VarInfo[] cvis = new VarInfo[var_infos.length];
      /*NNC:@LazyNonNull*/ VarInfo[] cvis_sorted = new VarInfo[var_infos.length];
      ...
      for (Invariant orig_inv : cslice.invs) {
        ...
        all_invs.add (inv);
        if (Invariant.logOn()) {
          /*NNC:@LazyNonNull*/ VarInfo[] child_vars = new VarInfo[var_infos.length];

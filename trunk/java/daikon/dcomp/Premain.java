...
public class Premain {
  ...
  public static void premain (String agentArgs, Instrumentation inst)
    ...
    //Kaituo: let is split using one single ','
...
//      	System.out.println(args[i]);
  ...
  static public class Transform implements ClassFileTransformer {
    ...
    public byte /*@Nullable*/ [] transform (ClassLoader loader, String className,
      ...
      // kaituo: for instrumenting ACC, should change if for different libraries
      if (className.startsWith ("org/apache/tools") || className.startsWith("org/junit") || className.contains("Test"))
    	  return classfileBuffer;
      
      // kaituo: in case of the following error
      // java.lang.AbstractMethodError
     //  at org.apache.commons.collections.collection.AbstractCollectionDecorator.equals(AbstractCollectionDecorator.java:135)
//      if(className.contains("Abstract"))
//    	  return classfileBuffer;
      
//      // kaituo: ignore inner class
//      if(!className.startsWith("org/apache/commons/collections/BeanMap") && className.contains("$"))
//    	  return classfileBuffer;

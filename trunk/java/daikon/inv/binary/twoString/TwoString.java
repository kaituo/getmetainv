...
public abstract class TwoString extends BinaryInvariant {
  ...
  public abstract InvariantStatus check_modified(/*@Interned*/ String v1,
                                                 /*@Interned*/ String v2, int count);

  public InvariantStatus check_unmodified(/*@Interned*/ String v1,
                                          /*@Interned*/ String v2, int count) {
